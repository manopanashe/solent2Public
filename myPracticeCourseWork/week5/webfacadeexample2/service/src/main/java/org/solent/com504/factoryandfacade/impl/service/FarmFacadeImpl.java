...
public class FarmFacadeImpl implements FarmFacade {
    ...
    @Override
    public Animal addAnimal(String animalTypeStr, String name, String animalFoodStr) {
        ...
        if(animalFoodStr == null ){
        throw new IllegalArgumentException("animalFoodStr cannot be null");
        }
